	...
	<div class="tpl-portlet-components">
		<div class="portlet-title">
			<div class="caption font-green bold">
				<span class="am-icon-code"></span> 新 增 文 章 <a
			...
			<div class="am-g tpl-amazeui-form">
				...
				<div class="am-u-sm-12 am-u-md-9">
					<form id="myform" name="myform" class="am-form am-form-horizontal"
						action="addarticle.do" method="post">
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label"> 作
								者 / Author </label>
							<div class="am-u-sm-9">
								<input type="text" id="author" name="author"
									placeholder="作 者  / Author"> <small></small>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">所 属 栏 目
								 / channel</label>
							<div class="am-u-sm-9">
								<select name="channel" style="width: 300px">
									<c:forEach items="${UID}" var="uid">
										<option value="${uid.uid}">${uid.upch}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">文
								章 内 容 / content</label>
							<div class="am-u-sm-9">
								<textarea type="text" id="content" name="content"
									placeholder="文章内容 / content"></textarea>
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">公
								告 时 间 / ctime</label>
							<div class="am-u-sm-9">
