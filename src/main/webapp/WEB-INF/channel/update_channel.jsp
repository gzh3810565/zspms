	...
	<div class="tpl-portlet-components">
		<div class="portlet-title">
			<div class="caption font-green bold">
				<span class="am-icon-code"></span> 栏目修改 <a
					...
					<form id="myform" name="myform" class="am-form am-form-horizontal"
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="cname" name="cname"
									value="${CHAN.cname }" style="float: left;"> <small>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<select name="uplev" style="width: 300px">
									<c:forEach items="${UPLEV }" var="uplev">
											<c:if test="${CHAN.uplev==uplev.uid }">

												<option value="${uplev.uid }" selected="selected">${uplev.uname }</option>
											</c:if>

											<c:if test="${CHAN.uplev!=uplev.uid }">
													<option value="${uplev.uid }">${uplev.uname }</option>
											</c:if>
									</c:forEach>
								</select>
							</div>
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">级别
								/ lev</label>
							<div class="am-u-sm-9">
								<input type="text" name="lev" id="lev" value="${CHAN.lev }">
								<small></small>
							</div>
						</div>
						<div class="am-form-group">
							...
							<c:if test="${CHAN.isleaf==1 }">
								<input type="radio" name="isleaf" checked="checked" value="1" >是
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="isleaf" value="0">否</c:if>
								
								
							<c:if test="${CHAN.isleaf!=1 }">
								<input type="radio" name="isleaf"  value="1" >是
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="isleaf" checked="checked" value="0">否</c:if>
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">顺序
								/ sort</label>
							<div class="am-u-sm-9">
								<input type="text" name="sort" id="sort" value="${CHAN.sort }">
								<small></small>
							</div>
